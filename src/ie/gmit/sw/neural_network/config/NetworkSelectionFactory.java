    ...
    public NetworkSelection getStandardSelections() {
        ...
        networkSelection.addSelection(
                ...
                "N-gram feature vector size",
                        ...
                        new Integer[] {128, 200, 235, 256, 300, 350, 512},
                        300
                )
        );
        ...
        networkSelection.addSelection(
                ...
                new Selection<>(
                        ...
                        "This is the size of the \"window\" that is passed over the input data, in characters.\n"
                                +"\tAll n-gram lengths up to n will be used as input (E.g. selecting 2 will store n-grams of size 1 AND 2 as input).",
                        "A value too low might not provide the network with enough information, while a value too high could overwhelm the network with sparse input data.",
                        new Integer[] {1, 2, 3},
                        2
                )
        );
        ...
        networkSelection.addSelection(
                ...
                new Selection<>(
                        ...
                        "One \"epoch\" means one full pass over the data during training.",
        ...
        networkSelection.addSelection(
                ...
                new Selection<>(
                        ...
                        new Double[] {0.0, 0.25, 0.5, 0.75, 0.8, 0.9},
                        0.8
                )
        );
        ...
        networkSelection.addSelection(
                ...
                new Selection<>(
                        ...
                        "Too few neurons may not provide the network with enough resources to make good predictions, while using too many might now allow the neurons to be fully trained with the limited data.",
                        new String[] {
                                "input + output",
                                "(input + output) / 2",
                                "(input + output) / 4",
